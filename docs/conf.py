# auto-generated by jupyter-book
...
extensions = ['sphinx_togglebutton', 'sphinx_copybutton', 'myst_nb', 'jupyter_book', 'sphinx_thebe', 'sphinx_comments', 'sphinx_external_toc', 'sphinx.ext.intersphinx', 'sphinx_panels', 'sphinx_book_theme', 'sphinx_click.ext', 'sphinx_inline_tabs', 'sphinxext.rediraffe', 'sphinxcontrib.bibtex', 'sphinx_jupyterbook_latex']
...
mathjax_config = {'TeX': {'Macros': {'N': '\\mathbb{N}', 'floor': ['\\lfloor#1\\rfloor', 1], 'bmat': ['\\left[\\begin{array}'], 'emat': ['\\end{array}\\right]']}}}
