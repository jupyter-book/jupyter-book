...
- title: mytitle   # Title of chapter or section
  file: myurl  # URL of section relative to the /content/ folder.
...
* **[The Jupyter Book CircleCI configuration file](https://github.com/executablebooks/jupyter-book/blob/master/.circleci/config.yml)**
  automatically deploys changes to the `jupyter-book` master branch to the live book. In
  particular, [this section builds the book HTML files](https://github.com/executablebooks/jupyter-book/blob/master/.circleci/config.yml#L74)
  while [this section builds the HTML and pushes them to a `gh-pages` branch](https://github.com/executablebooks/jupyter-book/blob/master/.circleci/config.yml#L31).
