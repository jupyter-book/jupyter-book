...
:::{important} Objective
Walk existing users through upgrading their books to Jupyter Book 2.
:::

:::{hint} TL;DR
Run `jupyter book` inside your existing book to automatically upgrade to Jupyter Book 2. Some manual cleanup may be needed.
:::
...
Some features from Jupyter Book 1 are still in development for version 2.0:
