...
:columns: title, Team Priority, closing_prs, reactions, updated
:sort:Team Priority-asc,reactions-desc
:limit:1000
:date-format: relative
```

[^1]: Our roadmap and priorities are constantly changing, and they are *not* commitments to do the work on any kind of timeline (or at all!). They are simply a way for us to help coordinate attention and work in the community, and to focus them on the things that feel most important to the team.
