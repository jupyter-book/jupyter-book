...
This page shows open issues from repositories in the `jupyter-book` organization, sorted by reactions (👍 and ❤️ and a few others)[^1]. If you'd like to see an issue get signal-boosted, add your own reaction—this helps us see what the community cares about, but it's not a commitment that we'll work on the issue.
