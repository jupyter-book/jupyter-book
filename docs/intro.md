...
{fa}`check,text-success` **[Write publication-quality content in markdown](content-types/markdown)**<br />
...
{fa}`check,text-success` **[Write content in Jupyter Notebooks](content-types/notebooks)**<br />
...
{fa}`check,text-success` **[Execute and cache your book's content](content/execute)**<br />
...
{fa}`check,text-success` **[Insert notebook outputs into your content](content/glue)**<br />
Generate outputs as you build your documentation, and insert them in-line with your content across pages.

{fa}`check,text-success` **[Add interactivity to your book](interactive/launchbuttons)**<br />
...
{fa}`check,text-success` **[Generate a variety of outputs](start/build)**<br />
This includes single- and multi-page websites, as well as [PDF outputs](advanced/pdf).

{fa}`check,text-success` **[Build books with a simple command-line interface](reference/cli)**<br />
