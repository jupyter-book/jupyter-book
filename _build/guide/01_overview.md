...
1. [**A collection of notebooks and markdown files**](https://github.com/jupyter/jupyter-book/tree/master/content). These are in `content/`. When you run `scripts/generate_book.py`,
   they'll be converted to `.md` files (or just copied if they're already `.md` files) and placed in `/_build`.
2. [**A Table of Contents file**](https://github.com/jupyter/jupyter-book/tree/master/_data/toc.yml) (`_data/toc.yml`). This is
   ...
   See [the TOC for this book](https://github.com/jupyter/jupyter-book/tree/master/_data/toc.yml) for a couple of examples.
3. [**A Jekyll configuration file**](https://github.com/jupyter/jupyter-book/tree/master/config.yml) that defines information about your book,
...
* Get yourself a copy of the jupyter-book repository. [Here's the repo URL on GitHub](https://github.com/jupyter/jupyter-book).
