...
Now that you've built the HTML for each **page**, you've
got **two options** for building the HTML for the whole **book**
and hosting it online.

1. **Option 1: GitHub builds and hosts your book**:
...
Once you've built the HTML for each page in your book, it's time to build the
HTML of the *entire book*. This means building the left Table of Contents and
...
HTML. There are a few different methods for installing Ruby, and their ease will depend
...
from most-straightforward to most-difficult.

#### Using `conda-forge` and `rb-github-pages`
...
O
nce you've finished those steps, head to [install ruby plugins](#install-ruby-plugins)
